...
int main(int argc, char *argv[]) {
    ...
    printf("\n\n%d\n\n", minHistoricTemp(array));

    int arrayOfAnnualMaxTemps[YEARS];
    annualMaxTemp(array, arrayOfAnnualMaxTemps);
    dump(arrayOfAnnualMaxTemps, YEARS);

    month_t arrayOfMonthsWithMorePrec[YEARS];
    monthWithMorePrec(array, arrayOfMonthsWithMorePrec);
    unsignedDump(arrayOfMonthsWithMorePrec, YEARS);

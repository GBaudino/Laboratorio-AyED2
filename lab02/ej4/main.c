...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    int copyInsertion[MAX_SIZE];
    array_copy(copyInsertion, array, length);
    ...
    /* do the actual sorting */
    insertion_sort(copyInsertion, length);
    ...
    */
    /* needs implementation */
    int copyQuick[MAX_SIZE];
    array_copy(copyQuick, array, length);
